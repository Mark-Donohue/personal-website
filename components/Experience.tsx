        ...
        {EXPERIENCES.map((item, index) => {
          return (
            <div key={index} className="flex flex-col">
              <div className="shadow-md rounded-xl mt-8 box-border">
                <h1 className="text-2xl font-semibold mb-4 pl-4 pt-4">{item.name}</h1>
                <p className="leading-7 mb-4 px-4 text-gray-800">{item.description}</p>
